...
export default function PasswordGenerator() {
  ...
  return (
    <div className="tool-shell">
      ...
      <LocalProcessingNote
        en="All processing runs locally in your browser. Your generated password will never be uploaded or stored on our server."
        zh="所有计算在浏览器本地执行，你生成的密码永远不会上传或保存在我们服务器。"
      />
